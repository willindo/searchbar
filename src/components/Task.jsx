  ...
  return (
    <>
      ...
      <div  id="flex">
        ...
        <div className="bar" ref={bara} style={{ backgroundColor: "#1a1433" }}></div>
          <div className="bar" ref={bara} style={{ backgroundColor: "#045459" }}></div>
          <div className="bar" ref={bara} style={{ backgroundColor: "#15c286" }}></div>
          <div className="bar" ref={bara} style={{ backgroundColor: "#abd96d" }}></div>
          <div className="bar" ref={bara} style={{ backgroundColor: "#fbbf54" }}></div>
          <div className="bar" ref={bara} style={{ backgroundColor: "#ec0f47" }}></div>
          <div className="bar" ref={bara} style={{ backgroundColor: "#700460" }}></div>
        </div>
